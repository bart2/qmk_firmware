...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
      ...
      _______, LGUI_T(KC_Z), LALT_T(KC_X), KC_C, KC_D, KC_V, _______, _______,              _______, _______,    KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH, _______,
    ...
    [1] = LAYOUT(
      ...
      _______,  KC_DLR,  KC_GRV, _______, KC_SCLN, BRACKETS, _______, _______,              _______, _______, KC_RBRC, KC_COLN, KC_AMPR, KC_ASTR, _______, _______,
